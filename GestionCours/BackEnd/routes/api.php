...
Route::prefix('sessionCours')->group(function (){
    ...
    Route::get('/list',[SessionCoursController::class,'getSessions']);
...
Route::prefix('annuleSession')->group(function (){
    Route::get('/list',[AnnuleSessionController::class,'index']);
    Route::post('/annule',[AnnuleSessionController::class,'store']);
    Route::post('/traiter',[AnnuleSessionController::class,'traiterDemandeAnnulation']);
});